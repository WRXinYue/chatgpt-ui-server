...
my_key = "sk-2Ftoor51LaUFa0l7I7EStRYclCbcMHLWkDYyiThyzEx8Endg"
...
#
#     # 业务数据分析师JD 岗位职责：...4534453
#     # aaaaaaaaaa
#     # 应聘简历 个人信息：...11111111111
#     # aaaaaaaaaa
#     # ['姓名', '联系号码', '性别', '年龄', '工作年数（数字）', '最高学历', '本科学校名称', '硕士学校名称', '是否在职',
...
jd_text = "业务数据分析师JD 岗位职责：...4534453"
resume_text = "应聘简历 个人信息：...11111111111"
selected_options = ['姓名', '联系号码', '性别', '年龄', '工作年数（数字）', '最高学历', '本科学校名称', '硕士学校名称', '是否在职', '当前职务', '历史任职公司列表', '技术能力', '经验程度', '管理能力']
df = analyze_resume(jd_text, resume_text, selected_options)